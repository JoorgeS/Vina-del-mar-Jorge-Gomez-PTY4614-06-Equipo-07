...
<div class="container-fluid">
  <div class="row">
    <!-- Sidebar -->
    <nav class="col-3 col-md-2 d-flex flex-column flex-shrink-0 p-3 bg-light" style="height: 100vh;">
      <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
        <img src="/corevota/public/img/logo_core.png" alt="Logo CORE" width="40" height="32" class="me-2">
    ...
    <main class="col-9 col-md-10 p-4">
      <iframe src="/corevota/views/pages/crearMinuta.php" 
              name="content-frame" 
              style="width:100%; height:90vh; border:none; border-radius:8px; background:white;">
      </iframe>
    </main>
  </div>
</div>
